...
public class AssertionGenerator {
    ...
    private final static Logger log = LoggerFactory.getLogger(AssertionGenerator.class);
    ...
    public Assertion generateAssertion(String remoteIP, SimpleAuthentication authToken, String recepientAssertionConsumerURL,
        ...
        Map<String, String> attributeMap = idpConfiguration.getAttributeMap().get(name);
